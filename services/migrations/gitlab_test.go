	...
	assertMilestonesEqual(t, []*base.Milestone{
		{
			...
			Updated: ptr(time.Date(2019, 11, 28, 8, 42, 44, 575000000, time.UTC)),
			State:   "active",
		},
		{
			Title:   "1.0.0",
			Created: time.Date(2019, 11, 28, 8, 42, 30, 301000000, time.UTC),
			Updated: ptr(time.Date(2019, 11, 28, 15, 57, 52, 401000000, time.UTC)),
			Closed:  ptr(time.Date(2019, 11, 28, 15, 57, 52, 401000000, time.UTC)),
			State:   "closed",
		},
	}, milestones)
	...
	assertIssuesEqual(t, []*base.Issue{
		{
			...
			Closed: ptr(time.Date(2019, 11, 28, 8, 46, 23, 275000000, time.UTC)),
		},
		{
			Number:     2,
			Title:      "Test issue",
			...
			Closed: ptr(time.Date(2019, 11, 28, 8, 45, 44, 959000000, time.UTC)),
		},
	}, issues)
