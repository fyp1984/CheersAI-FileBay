...
func TestGiteaDownloadRepo(t *testing.T) {
	...
	assertMilestonesEqual(t, []*base.Milestone{
		{
			...
			Deadline: ptr(time.Unix(1599263999, 0)),
			Updated:  ptr(time.Unix(0, 0)),
			State:    "open",
		},
		{
			Title:       "V1",
			...
			Created:     time.Unix(0, 0),
			Updated:     ptr(time.Unix(0, 0)),
			Closed:      ptr(time.Unix(1598985406, 0)),
			State:       "closed",
		},
	}, milestones)
	...
	assertIssuesEqual(t, []*base.Issue{
		{
			...
			Closed: ptr(time.Date(2020, 9, 1, 15, 49, 34, 0, time.UTC)),
		},
		{
			Number:      2,
			Title:       "Spam",
			...
			Closed: ptr(time.Unix(1598969497, 0)),
		},
	}, issues)
	...
	assertPullRequestEqual(t, &base.PullRequest{
		...
		Closed:      ptr(time.Unix(1598982934, 0)),
		...
		Merged:         true,
		MergedTime:     ptr(time.Unix(1598982934, 0)),
