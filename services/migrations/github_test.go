	...
	assertMilestonesEqual(t, []*base.Milestone{
		{
			...
			Deadline:    ptr(time.Date(2019, 11, 11, 8, 0, 0, 0, time.UTC)),
			Created:     time.Date(2019, 11, 12, 19, 37, 8, 0, time.UTC),
			Updated:     ptr(time.Date(2019, 11, 12, 21, 56, 17, 0, time.UTC)),
			Closed:      ptr(time.Date(2019, 11, 12, 19, 45, 49, 0, time.UTC)),
			State:       "closed",
		},
		{
			Title:       "1.1.0",
			Description: "Milestone 1.1.0",
			Deadline:    ptr(time.Date(2019, 11, 12, 8, 0, 0, 0, time.UTC)),
			Created:     time.Date(2019, 11, 12, 19, 37, 25, 0, time.UTC),
			Updated:     ptr(time.Date(2019, 11, 12, 21, 39, 27, 0, time.UTC)),
			Closed:      ptr(time.Date(2019, 11, 12, 19, 45, 46, 0, time.UTC)),
			State:       "closed",
		},
	}, milestones)
	...
	assertIssuesEqual(t, []*base.Issue{
		{
			...
			Closed: ptr(time.Date(2019, 11, 12, 20, 22, 22, 0, time.UTC)),
		},
		{
			Number:     2,
			Title:      "Test issue",
			...
			Closed: ptr(time.Date(2019, 11, 12, 21, 1, 31, 0, time.UTC)),
		},
	}, issues)
	...
	assertPullRequestsEqual(t, []*base.PullRequest{
		{
			...
			Closed:         ptr(time.Date(2019, 11, 12, 21, 39, 27, 0, time.UTC)),
			Merged:         true,
			MergedTime:     ptr(time.Date(2019, 11, 12, 21, 39, 27, 0, time.UTC)),
