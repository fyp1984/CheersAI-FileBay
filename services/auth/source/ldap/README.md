# CheersAI-FileBay LDAP Authentication Module
...
been authenticated, and account information is retrieved and passed to the
server login infrastructure.
...
* Group Name Filter (optional)
  ...
  * Example: (|(cn=filebay_users)(cn=admins))
